    ...
    return (
        <div id='quotes' className="relative flex flex-col">
            <div className="absolute w-full h-48 bg-gray-700 flex items-start justify-center">
                <div className="text-gray-100 text-4xl text-center font-bold mt-8 md:mt-4">My Quotes</div>
            </div>
            <div className="w-full flex flex-col items-center px-4 md:px-24 transform mt-32 md:mt-24 mb-12">
            <div className=" w-full flex items-center justify-center bg-white border-2 border-gray-300 shadow-lg rounded-xl transform md:py-12 py-4 px-2 md:px-24">
